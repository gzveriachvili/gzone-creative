  ...
  return (
    <div className='privacy-policy'>
      <Flex my='30px' flexDirection={'column'} align={'center'}>
        <Heading mt='50px'>Privacy Policy for GZONE Creative</Heading>
      </Flex>
      <Box as='div' className='privacy-policy-box' px='150px' mb='100px'>
        <p>
          At GZONE Creative, accessible from https://www.gzonecreative.com, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by GZONE Creative and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in GZONE Creative. This policy is not applicable
        ...
        <p>
          ...
          purposes Send you emails Find and prevent fraud Log Files GZONE
          Creative follows a standard procedure of using log files. These files
        ...
        <p>
          ...
          find the Privacy Policy for each of the advertising partners of GZONE
          Creative.
        </p>
        ...
        <p>
          ...
          advertisements and links that appear on GZONE Creative, which are sent
        ...
        <p>
          Note that GZONE Creative has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>

        <p>
          Third Party Privacy Policies GZONE Creative's Privacy Policy does not
        ...
        <p>
          GZONE Creative does not knowingly collect any Personal Identifiable
