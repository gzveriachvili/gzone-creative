...
import { BsInstagram, BsTwitter, BsFacebook, BsPerson } from 'react-icons/bs';
import { MdEmail, MdOutlineEmail } from 'react-icons/md';
import emailjs from 'emailjs-com';

import ContactSuccess from './util/ContactSuccess';
...
export default function Contact() {
  const { hasCopied, onCopy } = useClipboard('gzonecreative@gmail.com');
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            >
              ...
              >
                ...
                <Link href='https://twitter.com/CreativeGzone' target='_blank'>
                  <IconButton
                    aria-label='twitter'
                    variant='ghost'
                    size='lg'
